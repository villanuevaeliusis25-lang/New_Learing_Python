...
DINERO_PERDIDO = 150.0  # Costo de un "Viaje en Vano" o disputa (Bs.)

# BASE DE DATOS DE MAYORISTAS (5 Opciones)
data_mayoristas = [
    {
...
def simular_movimientos(escenario="con_app"):
    ...
    for i in range(total_transacciones):
        ...
        if escenario == "sin_app":
            # LÓGICA SIN APP: Selección Ponderada (Fuerte sesgo al precio más bajo/riesgoso)
            
            # IDs de 1 a 5
            mayoristas_ids = [1, 2, 3, 4, 5] 
            # Pesos: D(4)=30%, A(1)=30%, Resto=40% (El 60% se va a los más riesgosos por precio)
            ...
            # La opción tradicional ahora es el Mayorista 4 (el de precio base más bajo)
            opcion_tradicional = next(o for o in ofertas_calculadas if o['id'] == 4) 
...
if __name__ == '__main__':
    ...
    print("\n🚨 ESCENARIO 1: SIN APP (Tradicional y Riesgoso - 5 Mayoristas)")
    ...
    print("\n✅ ESCENARIO 2: CON APP (Estrategia BNT y Confianza Progresiva - 5 Mayoristas)")
